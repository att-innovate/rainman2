...
test-local: install-dev
	$(PYTHON) -m pytest -s --cov=rainman2 -v -m "not production" --ignore=tests/functional_tests/
...
start-cellular-simulator:
	$(PYTHON) rainman2/lib/environment/cellular/dev/server.py
