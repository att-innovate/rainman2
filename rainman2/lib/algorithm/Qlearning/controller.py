...
from rainman2.lib.algorithm import algorithm_template
from rainman2.lib.algorithm.Qlearning.agents import regression
from rainman2.lib.algorithm.Qlearning.agents import neural_nets
from rainman2.lib.algorithm.Qlearning.agents import tabular_q_learning
from rainman2.lib.algorithm.Qlearning.general import QlearningForGeneral
from rainman2.lib.algorithm.Qlearning.cellular import QlearningForCellular
...
QLEARNING_AGENTS = {
    'General': {
        ...
        'LinearRegression': regression.QLinearRegressionAgent,
        'NN': neural_nets.QNNAgent,
    },

    'Cellular': {
        'Naive': tabular_q_learning.QCellularAgent,
        'LinearRegression': regression.QCellularLinearRegressionAgent,
        'NN': neural_nets.QCellularNNAgent,
    }
}
